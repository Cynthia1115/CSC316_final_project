...
(function () {
    ...
    function ensureOverlay() {
        ...
        if (!document.getElementById("tri-insight-overlay")) {
            ...
            Object.assign(div.style, {
                position: "absolute", left: "24px", top: "70px", zIndex: zTop,
                ...
                maxWidth: "calc(100% - 230px)" // Leave space for legend on right
            });
            ...
            closeBtn.id = "tri-close"; closeBtn.textContent = "−";
            closeBtn.title = "Minimize tour";
            Object.assign(closeBtn.style, {
                border: "none", borderRadius: "50%", width: "28px", height: "28px",
                cursor: "pointer", background: "rgba(0,0,0,0.1)", color: "#2b2116",
                fontWeight: "700", fontSize: "20px", lineHeight: "1",
            ...
            closeBtn.onclick = () => {
                ...
                if (minimized) {
                    ...
                    closeBtn.title = "Restore tour";
                    // Reset dots to default state when minimizing
                    const dots = document.querySelector("#triangle-stage");
                    if (dots) {
                        const svg = d3.select("#triangle-stage svg");
                        svg.selectAll("circle").transition().duration(300).attr("opacity", 0.9);
                    }
                } else {
        ...
        if (!document.getElementById("tri-tools")) {
            ...
            function mkBtn(id, text) {
                ...
                Object.assign(b.style, {
                    border: "none", borderRadius: "10px", padding: "6px 10px", cursor: "pointer",
        ...
        if (!document.getElementById("tri-stats")) {
            ...
            Object.assign(chip.style, {
                position: "absolute", left: "24px", top: "24px", zIndex: zTop,
                background: "rgba(255,255,255,0.75)", backdropFilter: "blur(6px)",
                border: "1px solid rgba(0,0,0,0.08)", borderRadius: "12px",
    ...
    function renderTriangle(rows) {
        ...
        function pulse(cx, cy) {
            ...
            function loop() {
                halo.transition().duration(900).attr("opacity", 0.5).attr("stroke-width", 6).attr("r", 26)
        ...
        document.getElementById("tri-clear").onclick = () => {
            g.select(".brush").call(brush.move, null); dots.attr("opacity", 0.9);
