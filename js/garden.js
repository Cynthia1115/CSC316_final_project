// garden.js — v7 (Lively Breeze) — patched to keep overlay inside #garden-vis
(function () {
    ...
    function ensureInsightOverlay() {
      ...
      <style>
        /* Anchor the overlay to the garden container */
        #garden-vis { position: relative; }
        #insight-overlay{
        ...
        // Append inside the garden container (not the page)
        const host = document.querySelector('#garden-vis .uiwrap')
            || document.querySelector('#garden-vis');
    ...
    function renderGarden(rows) {
        ...
        const height = wrap.node().clientHeight || 650; // Increased default height
